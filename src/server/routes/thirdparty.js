 ...
 * @class ThirdParty
 */
var ThirdPartyRoute = (function (_super) {
    __extends(ThirdPartyRoute, _super);
    function ThirdPartyRoute(_app, _router) {
    ...
    ThirdPartyRoute.prototype.init = function () {
    ...
    ThirdPartyRoute.prototype.aribaRoutes = function () {
    };
    ThirdPartyRoute.prototype.wellsfargoRoutes = function () {
    };
    return ThirdPartyRoute;
}(base_1.BaseRoute));
exports.ThirdPartyRoute = ThirdPartyRoute;
